...
<input class="form-check-input form-check-success" type="checkbox" id="darkSwitch">
        ...
        <li><a href="https://ehs.dashboardtakeda.com//login">
        ...
        <div class="container">
          <div class="row g-3">
            <div class="col-6">
              ...
              <a href="https://ehs.dashboardtakeda.com//login-employee">
            ...
            <div class="col-6">
              <div class="card text-center shadow-sm wow fadeInUp" data-wow-duration="1s">
              <a href="https://ehs.dashboardtakeda.com//login-outsourcing">
            ...
            <div class="col-6">
              <div class="card text-center shadow-sm wow fadeInUp" data-wow-duration="1s">
              <a href="https://ehs.dashboardtakeda.com//contractor_id">
            ...
            <div class="col-6">
              <div class="card text-center shadow-sm wow fadeInUp" data-wow-duration="1s">
                <a href="https://ehs.dashboardtakeda.com//visitor_id">
