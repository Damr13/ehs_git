...
<html lang="id">
  <head>
    ...
    <!-- Title-->
    <title>Form Screening Covid-19 Outsourcing</title>
    <!-- Fonts-->
...
<path fill-rule="evenodd" d="M12 8a.5.5 0 0 1-.5.5H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5a.5.5 0 0 1 .5.5z"/>
          ...
          <div class="page-heading">
            <h6 class="mb-0">Form Screening Untuk Outsourcing</h6>
          </div>
          <!-- Settings-->
        ...
        <div class="card">
          <div class="card-body">
            <form action="#" method="GET">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:10px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Demam (Suhu tubuh > 37.5 C)</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose1" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <!-- Question Body 2-->
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Batuk/Pilek</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose2" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Kesulitan bernapas</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose3" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Sakit tenggorokan</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose4" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Menggigil</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose5" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Mual/muntah</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose6" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Kejang</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose7" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Sakit kepala</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose8" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Hilang Indera perasa</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose9" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Hilang indera penciuman</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose10" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Sakit persendian - Sakit otot</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose11" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Diare</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose12" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Ruam</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose13" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Kelelahan - Lemah</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose14" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Konjungtivitis (Mata merah/iritasi)</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose15" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Hidung berdarah</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose16" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Penurunan kesadaran</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose17" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="row" style="background-color: #f8f9fa;margin-bottom:20px;padding: 10px 0;">
                <div class="col-md-6 quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Kehilangan nafsu makan</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose18" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <!-- Question Body 19-->
              <div class="row" style="background-color: #f8f9fa;margin-bottom:40px;padding: 10px 0;">
                <div class="col-md-6  quest">
                  <div class="form-group1">
                    <h6 style="margin-bottom:0">Gejala neurologis</h6>
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
                    <input class="form-check-input" type="radio" name="planChoose19" id="Individual" style="margin-top:0">
                  </div>
                </div>
                <div class="col-md-3 d-flex justify-content-center quest">
                  <div class="head-question">
              ...
              <div class="form-group">
                <label class="form-label" for="exampleInputText">Tuliskan gejala lainnya jika ada yang dirasakan selain gejala diatas</label>
                <input class="form-control" id="exampleInputText" type="text" placeholder="Tulis Jawaban">
              </div>

              <!-- Button Next -->
              <a href="outsourcing_id3">
                <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="button" href="outsourcing_id3" >Selanjutnya
