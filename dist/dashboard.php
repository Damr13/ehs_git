  ...
  <body>
    ...
    <div class="header-area" id="headerArea">
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          <!-- Logo Wrapper-->
          <div class="logo-wrapper"><a href="<?php echo base_url(); ?>dashboard"><img src="img/core-img/ogol.png" alt=""></a></div>
          <!-- Navbar Toggler-->
    ...
    <div class="sidenav-wrapper" id="sidenavWrapper">
      ...
      <div class="sidenav-profile">
        ...
        <!-- User Info-->
        <div class="user-info">
          <h6 class="user-name mb-0"><?= $_SESSION['Nama'] ?></h6><span><?= $_SESSION['DeptName'] ?> (<?= $_SESSION['status_karyawan'] ?>)</span>
        </div>
      </div>
      <!-- Sidenav Nav-->
      <ul class="sidenav-nav ps-0">
        ...
        <li><a href="https://api.whatsapp.com/send/?phone=6285697391854&text=Halo+Admin%21+Saya+ingin+tanya+seputar+PIKOBAR&app_absent=0">
			...
			</svg>Chat<span class="badge bg-danger rounded-pill ms-2">Pikobar</span></a>
		</li>
        <li><a href="https://pikobar.jabarprov.go.id/articles?tab=jabar">
			...
			</svg>Info<span class="badge bg-success rounded-pill ms-2">Covid-19</span></a>
		</li>
        ...
        <li>
          <a href="<?php echo base_url(); ?>screening-report">
    ...
    <div class="page-content-wrapper">
      ...
      <div class="toast toast-autohide custom-toast-1 toast-danger home-page-toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="10000" data-bs-autohide="true">
        <div class="toast-body">
          ...
          <div class="toast-text ms-3 me-2">
            ...
            <small class="d-block"><?= $_SESSION['Nama'] ?></small>
            <?php
              date_default_timezone_set('Asia/Jakarta');
              $nik = $_SESSION['nik'];
              // echo date('Y-m-d');
              // exit();
              $sql = "SELECT count(nik) as jml
                      from screening
                      where nik='".$nik."'
                      and DATE_FORMAT(tgl, '%Y-%m-%d')='".date('Y-m-d')."'";
              // echo $sql;exit();
              $cek = mysqli_fetch_assoc($conn->query($sql));
              if($cek['jml'] <= 0) { ?>
                <small class="d-block">Anda belum melakukan pengisian form screening hari ini</small>
              <?php }else{ ?>
                <small class="d-block">Anda sudah melakukan pengisian form screening hari ini</small>
            <?php  }
            ?>
      ...
      <div class="affan-features-wrap py-3">
        <div class="container">
          <h6 style="font-weight: 600;font-size: 17px;margin-bottom:15px">Pilih Bahasa :</h6>
          <div class="row g-3">
          	<?php if($_SESSION['status_karyawan']=='Karyawan'){ ?>
	            <div class="col-6">
	              <div class="card text-center shadow-sm wow fadeInUp" data-wow-duration="1s">
	                <a href="<?php echo base_url(); ?>employee_id">
                    <div class="card-body"><img src="img/demo-img/idn-flag.png" alt="">
                      <h6 class="mb-0">IDN</h6>
                    </div>
	                </a>
	              </div>
	            </div>
	            <div class="col-6">
	              <div class="card text-center shadow-sm wow fadeInUp" data-wow-duration="1s">
	                <a href="<?php echo base_url(); ?>employee_eng">
                    <div class="card-body"><img src="img/demo-img/eng-flag.png" alt="">
                      <h6 class="mb-0">ENG</h6>
                    </div>
	                </a>
	              </div>
	            </div>
	          <?php }else{ ?>
	            <div class="col-12">
	              <div class="card text-center shadow-sm wow fadeInUp" data-wow-duration="1s">
	                <a href="<?php echo base_url(); ?>outsourcing_id">
