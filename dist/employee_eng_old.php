...
<html lang="id">
  <head>
    ...
    <!-- Title-->
    <title>Form Screening Covid-19 Employee</title>
    <!-- Fonts-->
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="header-content position-relative d-flex align-items-center justify-content-between">
          ...
          <div class="page-heading">
            <h6 class="mb-0">Form Screening For Employee</h6>
          </div>
          <!-- Settings-->
    ...
    <!-- Term & Conditions -->
  <?php
    $sql_temp = "SELECT nik,temp_condition
                FROM mstEmployee
                WHERE nik = '".$_SESSION['nik']."' ";
    $query_temp = mysqli_fetch_assoc($conn->query($sql_temp));
    if($query_temp['temp_condition'] == 'Belum'){
  ?>
    <div id="termcond" class="termcond">
      <div class="toast custom-toast-1 toast-danger term-condition" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="5000" data-bs-autohide="false">
        ...
        <div class="toast-body">
            <button id="checkterm" class="btn checkterm" onclick="save_temp_condition(<?php echo $_SESSION['nik']; ?>)" style="display:none;margin:auto;">Klik Untuk Lanjut</button>
        </div>
      </div>
    </div>
  <?php } ?>
      ...
      <div class="container">
        <div class="card bg-danger mb-3 shadow-sm element-card wow fadeInUp" data-wow-duration="1s">
          <div class="card-body">
            ...
            <p class="text-white mb-4" style="text-align:center;font-size:12px">
              Take an active role in efforts to prevent the spread of COVID-19 in the work area. 
              Takeda COVID-19 Screening, is carried out to ensure that everyone in the Site area is in good health. 
              Before entering the PT. Takeda Indonesia, everyone is MANDATORY to report their health condition by filling 
              out this form.
            </p>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="element-heading" style="margin-bottom:10px">
              <h6>Are you experiencing any of the following symptoms?</h6>
            </div>
            <!-- Header (Y / Tidak) -->
            ...
            <form method="POST" enctype="multipart/form-data" id="save_visitor" action="javascript:void(0)" >
              ...
              <!-- <a href="visitor_id3"> -->
                <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="submit" >Next
        ...
        <div class="card">
          <div class="card-header" style="padding:1.5rem">
              <div class="element-heading">
                <h6 style="color:#4f4e56">The question is not yet available</h6>
              </div>
          </div>
        </div>
      </div>
                  ...
                  <!-- <form method="POST" enctype="multipart/form-data" id="save_visitor3" action="javascript:void(0)" > -->
                    <div class="form-file">
                      ...
                      <label class="form-file-label justify-content-center" for="customFile">
                        <span class="form-file-button btn btn-primary shadow w-100" id="id_get_file">Click Here</span> 
...
<script type="text/javascript">
                ...
                success: (data) => {
                    if(data.respon == 'SUKSES'){
                      ...
                      $.ajax({
                        method     : "POST",
                        dataType : "JSON",
                        url       : 'employee_eng_save_picture.php',
                        data        : formData,
                        processData : false,
                        contentType : false,
                        cache       : false,
  ...
  function save_temp_condition(nik){
    $.ajax({
        type:'POST',
        url: 'temp_condition_update.php',
        data: {nik:nik},
        dataType  : "JSON",
        beforeSend: function(){
        },
