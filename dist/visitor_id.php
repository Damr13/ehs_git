...
<html lang="id">
  ...
  <body>
    ...
    <!-- Term & Conditions -->
    <div id="termcond" class="termcond">
      <div class="toast custom-toast-1 toast-danger term-condition" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="5000" data-bs-autohide="false">
        <div class="toast-body">
          <div class="toast-text ms-3 me-2">
            <div class="header-term">
              <h6>Syarat & Ketentuan</h6>
            </div>
            <div class="body-term scroll-term">
              <p class="mb-1 text-white">
                Dengan Hormat,
                <br><br>
                PT. Takeda Indonesia tetap berupaya dalam pencegahan penyebaran virus COVID-19 yang semakin 
                meningkat, melalui surat ini PT. Takeda Indonesia menyampaikan beberapa aturan yang berlaku 
                sebelum masuk dan beraktivitas :
                <br>
              </p>
              <ul>
                <li>
                  Sebelum memasuki area PT. Takeda Indonesia, setiap orang wajib mencuci tangan menggunakan 
                  sabun dan air mengalir atau hand sanitizer yang telah tersedia di depan pos security serta 
                  mencuci tangan secara berkala selama beraktivitas di area PT. Takeda Indonesia.
                </li>
                <li>
                  Setiap karyawan termasuk karyawan outsourced wajib mengisi form screening COVID-19 setiap hari 
                  (hari kerja maupun hari libur) sesuai dengan kondisi Kesehatan sebenarnya.
                </li>
                <li>
                  Setiap orang tetap menjaga jarak aman minimal 1 meter terhadap orang lain pada setiap aktivitas 
                  yang dilakukan.
                </li>
                <li>
                  Setiap orang wajib menggunakan masker medis selama berada di area PT. Takeda Indonesia kecuali 
                  pada kondisi tertentu (seperti makan, berada di meja kerja sendiri, senam dan berpidato) dengan 
                  tetap menjaga jarak aman minimal 1 meter terhadap orang lain.
                </li>
                <li>
                  Karyawan termasuk outsourced tidak diperkenankan melakukan perjalanan keluar JABODETABEK pada 
                  hari kerja atau hari libur kecuali alasan khusus dan mendesak. Untuk kasus mendesak keluarga 
                  sakit maka harus disertai surat dokter. Perjalanan keluar JABODETABEK harus mendapatkan 
                  persetujuan dari Head Department serta tetap melaksanakan protokol kesehatan COVID-19 selama 
                  perjalanan dan di tempat kunjungan. Karyawan wajib melakukan test COVID-19 (Antigen atau PCR) 
                  dan melakukan karantina mandiri 3 hari dirumah domisili sebelum mulai masuk kerja kembali 
                  (dipotong cuti tahunan).
                </li>
                <li>
                  Setiap perjalanan yang dilakukan keluar JABODETABEK wajib dilaporkan kepada HR.
                </li>
                <li>
                  Setiap orang wajib mematuhi rambu-rambu protokol Kesehatan COVID-19 yang dipasang pada setiap 
                  area di PT. Takeda Indonesia.
                </li>
                <li>
                  Hindari aktivitas yang bersifat masif atau berkerumun di dalam maupun di luar area PT. Takeda Indonesia
                </li>
              </ul>
              <br>
              <p class="mb-1 text-white">
                Kebijakan ini berlaku untuk semua karyawan termasuk karyawan outsourced, internship dan tamu/kontraktor yang ada di PT. Takeda Indonesia.
                Masa berlaku Kebijakan ini dimulai sejak ditandatanganinya surat ini sampai dengan adanya pemberitahuan lebih lanjut . 
                <br><br>
                Demikian Kebijakan ini kebijakan ini dibuat agar menjadi perhatian dan dilaksanakan dengan baik. Terimakasih.
                <br>
                <br>
                Bekasi,<br>    
                PT. Takeda Indonesia,
                ...
                <br>
                <br><br>
                Hardiansyah Sucipta<br>
                Head of Plant
              </p>
            </div>
            <!-- <small class="d-block">2 min ago</small> -->
          </div>
        </div>
        <div class="toast-body">
          <div class="toast-text ms-3 ms-2 term-checkbox">
            <input type="checkbox" id="termcheckbox">
            <label>Saya mengerti dan menerima persyaratan diatas</label><br>
          </div>
        </div>
        <div class="toast-body">
            <button id="checkterm" class="btn checkterm" style="display:none;margin:auto;">Klik Untuk Lanjut</button>
        </div>
      </div>
    </div>
            ...
            <form method="POST" enctype="multipart/form-data" id="save_visitor" action="javascript:void(0)" >
              ...
              ?>
                <div class="form-group">
                  <label class="form-label" for="exampleInputText"><?php echo $key_qt['title']; ?></label>
                  <?php if($key_qt['type']=='line'){ ?>
                    <?php
                      ...
                      ?>
                    <input class="form-control" id="ans_<?php echo $key_qt['type']; ?>_<?php echo $id_survey ?>_<?php echo $key_qt['page']; ?>_<?php echo $key_qt['id']; ?>_<?php echo $row_ans['id']; ?>" name="qt_<?php echo $key_qt['type']; ?>_<?php echo $id_survey ?>_<?php echo $key_qt['page']; ?>_<?php echo $key_qt['id']; ?>_<?php echo $row_ans['id']; ?>" type="text" <?php echo $req; ?> placeholder="<?php echo $row_ans['title']; ?>"/>
                  <?php }elseif($key_qt['type']=='date'){ ?>
                    <?php
                      ...
                      <input class="form-control" id="ans_<?php echo $key_qt['type']; ?>_<?php echo $id_survey ?>_<?php echo $key_qt['page']; ?>_<?php echo $key_qt['id']; ?>_<?php echo $row_ans['id']; ?>" name="qt_<?php echo $key_qt['type']; ?>_<?php echo $id_survey ?>_<?php echo $key_qt['page']; ?>_<?php echo $key_qt['id']; ?>_<?php echo $row_ans['id']; ?>" type="date" <?php echo $req; ?> placeholder="<?php echo $row_ans['title']; ?>"/>
                    
                  <?php }elseif ($key_qt['type']=='paragraph') { ?>
                    <?php
                          $sql_ans = "SELECT a.title, a.id, a.rightAns
                                      FROM do_answers a 
                                      LEFT JOIN do_questions b ON a.question = b.id
    ...
    <!-- page3 -->
    <div class="page-content-wrapper py-3" id="id_visitor3" style="display: none;">
      <div class="container">
        <div class="card bg-danger mb-3 shadow-sm element-card wow fadeInUp" data-wow-duration="1s">
          <div class="card-body">
            <div class="logo-wrapper" style="text-align:center">
...
<path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
    ...
    <!-- Term & Conditions JS -->
    <script src="js/default/termcond.js"></script>
  </body>
</html>
...
<script type="text/javascript">
  ...
  $(document).ready(function (e) {
        ...
        $('#save_visitor3').submit(function(e) {
            e.preventDefault();
            var dataString = $("#save_visitor, #save_visitor2, #save_visitor3").serialize();
            var data_form = JSON.stringify(dataString);
            var data_form = data_form.escapeSpecialChars();
            // data_form  = data_form.replace(/[\u007F-\uFFFF]/g, function(chr) {
                ...
                success: (data) => {
                    if(data.respon == 'SUKSES'){
                      ...
                      $.ajax({
                        method     : "POST",
                        dataType : "JSON",
                        url       : 'visitor_id_save_picture.php',
                        data        : formData,
                        processData : false,
                        contentType : false,
                        cache       : false,
                        ...
                        success: function(data_detail) {
                          swal({
                              ...
                              window.location = "https://ehs.dashboardtakeda.com/";
                          });

                          // if(data.level_skor==1 || data.level_skor==2){
