        ...
        <div class="header-content position-relative d-flex align-items-center justify-content-between">
          <!-- Back Button-->
            <div class="back-button">
                <a href="https://ehs.dashboardtakeda.com?ehs=1">
      ...
      <div class="container px-0">
        ...
        <div class="footer-nav position-relative">
          <ul class="h-100 d-flex align-items-center justify-content-between ps-0">
            <li class="active"><a href="https://ehs.dashboardtakeda.com?ehs=1"><svg width="20" height="20" viewBox="0 0 16 16" class="bi bi-house" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                      ...
                      $.ajax({
                        ...
                        success: function(data_detail) {
                          ...
                          swal({
                              ...
                              window.location = "https://ehs.dashboardtakeda.com/?ehs=1";
                          });
