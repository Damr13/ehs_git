<?php
    ...
    $return = array('respon' => 'SUKSES', 'judgement' => $judgement, 'legend' => $legend, 'rating_risk' => $rating_risk);
    ...
    function cek_hasil($idResponse,$conn){
        ...
        $sql_jdg = "INSERT INTO do_judgement (idResponse, category, tgl, total_risk, total_tracing,judgement)
             VALUES (".$idResponse.",'Contractor',NOW(),".$sum_risk.",".$persen_tracing.",'".$judgement."')";
        // echo $sql_insert;exit();
        $insert_jdg = mysqli_query($conn,$sql_jdg);

        $data = array('judgement' => $judgement, 'legend' => $legend, 'rating_risk' => $rating_risk );
        return $data;
    }
