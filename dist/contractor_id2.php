            ...
            <form action="#" method="GET">
              ...
              <div class="form-group">
                <label class="form-label" for="defaultSelect">
                  Apakah dilingkungan RT tempat tinggal Anda terdapat pasien terkonfirmasi positif COVID-19? <br>(Jika jawaban dipilih "Ya" info segera ke Security yang bertugas atau Manager departemen dimana Anda akan bekerja)
                </label>
              ...
              <a href="https://ehs.dashboardtakeda.com/">
                <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="button" href="https://ehs.dashboardtakeda.com/visitor_id2" >Kirim
