    ...
    <div class="header-area" id="headerArea">
      <div class="container">
        ...
        <div class="header-content header-style-five position-relative d-flex align-items-center justify-content-between">
          <!-- Logo Wrapper-->
          <div class="logo-wrapper"><a href="index.php"><img src="img/core-img/ogol.png" alt=""></a></div>
          <!-- Navbar Toggler-->
...
<path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
      ...
      <div class="copyright-info">
        <p>&copy; Copyrigth 2020 Takeda Indonesia Developed by<a href="https://digitaloptima.id">Digital Optima Integra</a></p>
      </div>
    </div>
        ...
        <div class="container">
          <div class="row g-3">
            <div class="col-6">
              ...
              <a href="login.php">
                <div class="card-body"><img src="img/demo-img/workers.png" alt="" href="login.php">
            ...
            <div class="col-6">
              <div class="card text-center shadow-sm wow fadeInUp" data-wow-duration="1s">
                <a href="visitor_id.php">
                <div class="card-body"><img src="img/demo-img/visitors.png" href="visitor_id.php">
