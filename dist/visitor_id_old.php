...
<path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
    ...
    <div class="page-content-wrapper py-3">
      ...
      <div class="container">
        <div class="card">
          <div class="card-body">
            <form action="#" method="GET">
              ...
              <div class="form-group">
                <label class="form-label" for="defaultSelect">Tujuan Kedatangan</label>
                <select class="form-select" id="defaultSelect" name="defaultSelect" aria-label="Default select example">
                  <option value="1" selected>Magang / PKL</option>
                  <option value="2">Ambil Kirim Barang</option>
                  <option value="3">Meeting Bertemu Karyawan Takeda</option>
                  <option value="3">Takeda Head Office</option>
                </select>
              </div>
              <div class="form-group">
                <label class="form-label" for="defaultSelect">Sebelum berkunjung/ datang ke Takeda apakah Anda mengunjungi atau bekerja di tempat lain dimana terdapat kasus positif COVID-19?</label>
                <select class="form-select" id="defaultSelect" name="defaultSelect" aria-label="Default select example">
        ...
        <div class="form-group">
                <label class="form-label" for="exampleInputText">Kapan Anda berkunjung atau Bekerja pada tempat tersebut</label>
                <input class="form-control" id="exampleInputText" type="text" placeholder="Waktu Terakhir Berkunjung">
            </div>
              <div class="form-group">
            ...
            <a href="visitor_id2.php">
                 <button class="btn btn-primary w-100 d-flex align-items-center justify-content-center" type="button" >Selanjutnya
